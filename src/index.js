...
const mongoURI =
"mongodb+srv://Alwalaabhishek:Abhi@090601@cluster0.lkmkxid.mongodb.net/?retryWrites=true&w=majority";
...
const tallySchema = new Schema({
  ...
  const corona_statics = mongoose.model("corona_statics", tallySchema);
  corona_statics.insertMany(data)
  ...
  app.get('/hotspotStates', async (req, res) => {
    const result = await corona_statics.aggregate([
